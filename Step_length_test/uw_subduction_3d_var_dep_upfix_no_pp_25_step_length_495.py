...
outputPath = os.path.join(os.path.abspath("/scratch/n69/tg7098/"),'uw_subduction_3d_var_dep_upfix_no_pp_'+res+'_'+str(coh_dim)+'_short_slab_165/')
if uw.mpi.rank ==0:
