...
outputPath = os.path.join(os.path.abspath("/scratch/n69/tg7098/"),'uw_subduction_3d_var_dep_upfix_no_pp_'+res+'_'+str(coh_dim)+'_sm_visc_'+str(int(SP_mantle_visc))+'/')
if uw.mpi.rank ==0:
...
UPCrustViscosity 	= UP_crust_visc
UPMantleViscosity 	= UP_mantle_visc
SPCrustViscosity 	= SP_crust_visc
SPMantleViscosity 	= SP_mantle_visc
SCrustLongViscosity     = SP_crust_visc
SMantleLongViscosity    = SP_mantle_visc
SCrustShortViscosity    = SP_crust_visc
SMantleShortViscosity   = SP_mantle_visc
